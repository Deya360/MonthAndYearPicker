package com.whiteelephant.monthandyearpicker;
...
public class MonthPickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    private void setYearViewShown() {
        _monthPicker.setYearViewShown();
    }
    ...
    public static class Builder {
        ...
        private boolean _monthViewShown = true, _yearViewShown;
         ...
         * @return Builder
         */
        public Builder setMonthRange(int minMonth,
                                     int maxMonth) {
            if (minMonth >= Calendar.JANUARY && minMonth <= Calendar.DECEMBER &&
         ...
         * @return Builder
         */
        public Builder setMonthAndYearRange(int minMonth,
                                            int maxMonth,
        ...
        /**
         * Sets the Month picker view as the default selected view in the dialog
         *
         * @return Builder
         */
        public Builder setMonthViewDefault() {
            this._monthViewShown = true;
            return this;
        }

        /**
         * Sets the Year picker view as the default selected view in the dialog
         *
         * @return Builder
         */
        public Builder setYearViewDefault() {
            this._monthViewShown = false;
            return this;
        }
        ...
        public MonthPickerDialog build() {
            ...
            if (!_monthViewShown)
                monthPickerDialog.setYearViewShown();
